...
/**
 * [detectedWith] runs with the provided [Driver] to automatically detect the characteristics of the Neo4j target.
...
object Neo4jDetector {
    /**
     * [detect] runs with the provided [Driver] to automatically detect the characteristics of the Neo4j target.
     *
     * @return [Neo4j]
     */
